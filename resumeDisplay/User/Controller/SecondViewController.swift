...
class SecondViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row == 0 {
            myCell.slideDescLabel.text = "C Programming"
            myCell.slideTitleLabel.text = "Basic"
            myCell.slideImageView.image = #imageLiteral(resourceName: "c")
            myCell.imageBackground.backgroundColor = .secondarySystemFill
        } else if indexPath.row == 1 {
            myCell.slideDescLabel.text = "Swift / iOS Development"
            myCell.slideTitleLabel.text = "Intermediate"
            myCell.slideImageView.image = #imageLiteral(resourceName: "swift")
            myCell.imageBackground.backgroundColor = .secondarySystemFill
            
        } else if indexPath.row == 2 {
            myCell.slideDescLabel.text = "Microsoft Excel"
            myCell.slideTitleLabel.text = "Proficient"
            myCell.slideImageView.image = #imageLiteral(resourceName: "brand_microsoft_excel_icon_157879")
            myCell.imageBackground.backgroundColor = .secondarySystemFill
        } else if indexPath.row == 3 {
            myCell.slideDescLabel.text = "Microsoft Office"
            myCell.slideTitleLabel.text = "Proficient"
            myCell.slideImageView.image = #imageLiteral(resourceName: "office icon")
            myCell.imageBackground.backgroundColor = .secondarySystemFill
        } else if indexPath.row == 4 {
            myCell.slideDescLabel.text = "Adobe Photoshop"
            myCell.slideTitleLabel.text = "Proficient"
            myCell.slideImageView.image = #imageLiteral(resourceName: "ps icon")
            myCell.imageBackground.backgroundColor = .secondarySystemFill
        }
        return myCell
